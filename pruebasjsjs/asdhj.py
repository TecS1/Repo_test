...
class App(customtkinter.CTk):
    ...
    def create_frame(self, frame_id, color):
        App.frames[frame_id] = customtkinter.CTkFrame(self, corner_radius = 8,
            fg_color = color)
        ...
        bt_from_frame1 = customtkinter.CTkButton(App.frames[frame_id], text="Teeeeest "+ self.color_by_id(self.num_of_frames) , command=lambda:print("test " + color) )
